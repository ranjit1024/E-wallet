  ...
  return (
    <div className={`${monaSans.className}`}>
      ...
      >
        ...
        <div className="absolute opacity-50 right-[20%] max-md:hidden -top-4">
          <Image src="/side2.png" alt="" width={45} height={48} />
        </div>
        <div className="absolute opacity-40 left-[20%] max-md:left-0 max-md:top-2 top-3">
          <Image
            width="40"
            height="50"
      ...
      <motion.div
        ...
        className=" mt-10 flex justify-center w-[100%] max-md:flex-wrap max-md:px-5 items-center  gap-12 px-[12%] pt-20"
      >
      ...
      <div className="all cards grid grid-cols-3  max-sm:flex max-md:flex-wrap px-40 mt-12 gap-10 max-md:px-5 max-md:gap-5  max-md:w-[100vw]  ">
        <motion.div
      ...
      <div className="mt-[10%]">
        <div className="px-[11%] flex gap-10 max-md:flex-wrap max-md:px-5   max-md:w-[100vw] max-md:justify-center ">
          <motion.div
      ...
      <div className="mt-[10%] mx-[11%] max-md:mx-2 flex gap-10 max-sm:flex-wrap">
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
      ...
      <div className="footer mt-[13%] mx-2">
        <footer className="flex flex-row  max-md:flex  max-md:flex-wrap fitems-center justify-center w-full py-6 text-center border-t gap-y-6 gap-x-12 border-slate-200 md:justify-between">
